...
namespace App\Services\Ocr\EasyOCR\V1;

use App\Services\Ocr\EasyOCR\V1\JsonParser;
...
class Ocr implements OcrInterface
{
    ...
    public function analyze(
        ...
        try {
            ...
            exec("python /opt/data/src/main.py ocr analyze --image_path={$imageFilepath} --engine=easyocr", $pythonResult, $resultCode);
            if ($resultCode !== 0) {
