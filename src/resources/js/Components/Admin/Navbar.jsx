                ...
                <div className="navbar text-gray-500">
                    <div className="flex">
                        <div className="shrink-0 flex items-center">
                            <Link href={route('admin.dashboard')} className="mx-6">
