        ...
        <header className="bg-base-200 sticky drawer-content top-0 w-full z-10 h-16 bg-opacity-70 backdrop-blur">
            <nav className="mt-0 mb-0 mx-auto w-full relative">
                <div className="navbar">
                    <div className="flex">
                        <Link href={route('user.dashboard')} className="mx-6 hidden sm:block">
                            <ApplicationLogo className="block h-9 w-auto fill-current" />
                        </Link>
                        <label htmlFor="user-drawer" aria-label="open sidebar" className="btn btn-square btn-ghost sm:hidden">
